...
import com.yakgwa.kullow.ar.SampleApplication.utils.VideoBackgroundShader;
...
public class SampleAppRenderer
{
    ...
    private final com.yakgwa.kullow.ar.SampleApplication.SampleAppRendererControl mRenderingInterface;
    ...
    public SampleAppRenderer(com.yakgwa.kullow.ar.SampleApplication.SampleAppRendererControl renderingInterface, Activity activity,
