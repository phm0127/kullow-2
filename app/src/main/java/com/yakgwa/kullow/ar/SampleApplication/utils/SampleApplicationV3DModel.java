...
public class SampleApplicationV3DModel extends MeshObject
{
    ...
    public void initShaders()
    {
        ...
        if (mUseTransparency)
        {
            objMtlProgramID = com.yakgwa.kullow.ar.SampleApplication.utils.SampleUtils.createProgramFromShaderSrc(
                DiffuseLightMaterials.VERTEX_SHADER,
                DiffuseLightMaterials.FRAGMENT_SHADER);

            com.yakgwa.kullow.ar.SampleApplication.utils.SampleUtils.checkGLError("v3d GLInitRendering #0");
        ...
        com.yakgwa.kullow.ar.SampleApplication.utils.SampleUtils.checkGLError("v3d GLInitRendering #1");
    ...
    public void render(float[] modelViewMatrix, float[] modelViewProjMatrix)
    {
        ...
        com.yakgwa.kullow.ar.SampleApplication.utils.SampleUtils.checkGLError("v3d renderFrame");
    }
