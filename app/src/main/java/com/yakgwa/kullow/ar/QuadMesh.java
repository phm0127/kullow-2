...
public class QuadMesh extends MeshObject {
    ...
    static float locationNum =100; // 위치 변경하려면 여기 값 변경 * Default 100


    private final static double[] planeVertices =
            {
                    -10.0f * scaleNum, locationNum, 10.0f, //bottom-left corner
                    10.0f * scaleNum, locationNum, 10.0f, //bottom-right corner
                    10.0f * scaleNum, locationNum + 20.0f * scaleNum, 10.0f, //top-right corner
                    -10.0f * scaleNum, locationNum + 20.0f * scaleNum, 10.0f //top-left corner
            };
   ...
   /*
    private final static double planeVertices[] =
            {
                    -30.0f, 50.0f, 10.0f, //bottom-left corner
                    30.0f, 50.0f, 10.0f, //bottom-right corner
                    30.0f, 110.0f, 10.0f, //top-right corner
                    -30.0f, 110.0f, 10.0f //top-left corner
            };
    private final static double planeTexcoords[] =
            {
                    0.0f, 0.0f, //tex-coords at bottom-left corner
